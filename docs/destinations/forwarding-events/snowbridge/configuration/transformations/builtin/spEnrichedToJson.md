...
The transformation to JSON is done via the [analytics SDK](/docs/modeling-your-data/analytics-sdk/index.md) logic, specifically in this case the [Golang analytics SDK](/docs/modeling-your-data/analytics-sdk/analytics-sdk-go/index.md).
