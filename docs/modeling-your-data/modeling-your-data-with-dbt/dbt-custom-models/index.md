...
- Redshift/Postgres users: be careful about joining context or self-describing event tables onto the main events table. Deduplication logic needs to be applied to avoid one-to-many joins. We have provided a macro - `get_sde_or_context()` - for you to use for this purpose from v0.14.0 of the snowplow-utils package. Check out the [package documentation](https://snowplow.github.io/dbt-snowplow-utils/#!/overview/snowplow_utils) on how to use it.
