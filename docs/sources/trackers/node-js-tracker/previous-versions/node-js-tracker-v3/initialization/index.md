...
Assuming you have completed the [Node.js Tracker Setup](/docs/sources/trackers/node-js-tracker/initialization/index.md) for your project, you are now ready to initialize the Tracker.
