...
Visit documentation about [tracking events](/docs/sources/collecting-from-own-applications/lua-tracker/tracking-specific-events/index.md) to learn about other supported event types.
