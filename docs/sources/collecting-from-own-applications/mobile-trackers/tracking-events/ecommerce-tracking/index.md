...
Each ecommerce event is a [self-describing](docs/sources/collecting-from-own-applications/mobile-trackers/custom-tracking-using-schemas/index.md) event using a single schema,
