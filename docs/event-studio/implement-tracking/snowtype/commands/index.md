...
**Options**
 ...
 - `-r, --repositories` Local Data Structure repositories generated from the [snowplow-cli](/docs/event-studio/programmatic-management/snowplow-cli/data-structures/index.md).
