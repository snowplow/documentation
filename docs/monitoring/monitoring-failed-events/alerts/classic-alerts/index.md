...
To receive alerts you must have the failed events [monitoring](/docs/monitoring/monitoring-failed-events/index.md) feature switched on in Snowplow Console.
