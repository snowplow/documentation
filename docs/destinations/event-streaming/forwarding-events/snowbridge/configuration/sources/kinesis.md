...
To use this source, you need the AWS-specific version of Snowbridge that can only be run on AWS. See [the page on Snowbridge distributions](/docs/destinations/event-streaming/forwarding-events/snowbridge/getting-started/distribution-and-deployment.md) for more information.
