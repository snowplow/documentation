...
With BDP Cloud, you don’t need to set up any cloud infrastructure yourself. See [deployment model](/docs/get-started/deployment-model/index.md) for a comparison between BDP Cloud and BDP Enterprise.
