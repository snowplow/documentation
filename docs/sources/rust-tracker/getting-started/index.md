...
There are additional optional arguments to configure the tracker. To learn more about configuring how events are sent, check out [this page](/docs/sources/rust-tracker/initialization-and-configuration/index.md).
...
Visit documentation about [tracking events](/docs/sources/rust-tracker/tracking-events/index.md) to learn about other supported event types. You may also want to read about [adding more data to tracked events](/docs/sources/rust-tracker/adding-data/index.md).
