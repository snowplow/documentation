...
By default the subject has one piece of information in it already, the [platform](/docs/snowplow-events/going-deeper/event-parameters/index.md#application-parameters) `["p" => "srv"]`.
...
For a full list of supported platforms, please see the [Event Parameters reference](/docs/snowplow-events/going-deeper/event-parameters/index.md#application-parameters).
