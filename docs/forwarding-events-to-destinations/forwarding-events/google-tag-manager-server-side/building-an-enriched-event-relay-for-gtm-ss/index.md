...
To understand the fundamentals that are discussed here, please read the [Custom Integrations documentation](/docs/forwarding-events-to-destinations/forwarding-events/custom-integrations/).
...
1. Set up the [Snowplow Client](/docs/forwarding-events-to-destinations/forwarding-events/google-tag-manager-server-side/snowplow-client-for-gtm-ss/) within your GTM Server Side Container.
2. Create a [Custom Integration application for AWS or GCP](/docs/forwarding-events-to-destinations/forwarding-events/custom-integrations/).
