...
| `repositories`          | `string[]` | An array of paths to local [Snowplow CLI](/docs/api-reference/snowplow-cli/data-structures/index.md) schema repositories to generate code for.                            | ❌        |
