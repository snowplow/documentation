...
<TabItem value="fractribution" label="Snowplow Fractribution">
 ...
 - have a table with revenue data by users (domain_userid, user_id) that serves as another source for the fractribution calculations, you can choose from the following options:
