...
This will track a self-describing event with [the schema described here](/docs/snowplow-events/ootb-data/page-and-screen-view-events/index.md#screen-view-events).
