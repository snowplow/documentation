...
You may track it manually using global context and [the geolocation schema](/docs/snowplow-events/ootb-data/geolocation/index.md#geolocation-context-entity-tracked-in-apps).
