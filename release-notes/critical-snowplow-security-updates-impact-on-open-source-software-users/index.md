...
This is an update to our [previous notification](/release-notes/) informing users of Snowplow Open Source Software releases (pre-2024)* of the release of security patches for 5 CVEs, of which 4 are critical DOS type issues.
