...
The values stored in the cookies listed above are mapped into the [tracker protocol](/docs/snowplow-events/index.md) when events are sent to a Snowplow Collector.
