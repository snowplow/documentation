...
The process involves the following high level steps:
  ...
  - If manually inserting the tag into your website or tag management solution: Snowplow customers can generate a tag snippet in Snowplow Console [here](https://console.snowplowanalytics.com/tag-generator). Other users can use and edit the standard tag [here](../tracker-setup/index.md).
