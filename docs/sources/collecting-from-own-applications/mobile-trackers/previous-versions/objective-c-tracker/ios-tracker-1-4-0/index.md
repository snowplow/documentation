...
```swift
    github "snowplow/snowplow-objc-tracker" ~> 1.4
```
...
[Here](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/index.md#application-parameters) a full list of the supported platform values.
