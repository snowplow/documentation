...
Page view events are the basic building blocks for the [Snowplow web data model](/docs/modeling-your-data/modeling-your-data-with-dbt/dbt-web-data-model/index.md).
