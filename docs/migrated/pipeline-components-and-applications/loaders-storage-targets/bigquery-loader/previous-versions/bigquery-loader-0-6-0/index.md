...
- All topics and subscriptions (`input`, `typesTopic`, `typesSubscription`, `badRows` and `failedInserts`) are explained in the [topics and message formats](/docs/migrated/open-source/setup-snowplow-on-gcp/setup-bigquery-destination/technical-architecture/#topics-and-message-formats) section.
