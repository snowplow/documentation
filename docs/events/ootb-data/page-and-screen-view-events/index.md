...
See the [documentation for the JavaScript tracker](/docs/sources/web-trackers/tracking-events/page-views/index.md) to learn how to track a page view event.
