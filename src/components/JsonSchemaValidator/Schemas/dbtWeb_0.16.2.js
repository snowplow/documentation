export const Schema = {
  ...
  properties: {
    ...
    snowplow__dev_target_name: {
      ...
      longDescription: 'The [target name](https://docs.getdbt.com/reference/profiles.yml) of your development environment as defined in your `profiles.yml` file. See the [Manifest Tables](/docs/modeling-your-data/modeling-your-data-with-dbt/dbt-operation/#manifest-tables) section for more details.',
      packageDefault: 'dev',
      group: 'Warehouse and Tracker',
    },
    ...
    snowplow__page_view_context: {
      ...
      longDescription: 'The table name for your page view entity.',
    ...
    snowplow__iab_context: {
      ...
      longDescription: 'The table name for your IAB entity.',
      packageDefault: 'com_iab_snowplow_spiders_and_robots_1',
      group: 'Warehouse Specific',
    },
    snowplow__ua_parser_context: {
      ...
      longDescription: 'The table name for your UA entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_ua_parser_context_1',
      group: 'Warehouse Specific',
    },
    snowplow__yauaa_context: {
      ...
      longDescription: 'The table name for your YAUAA entity.',
      packageDefault: 'nl_basjes_yauaa_context_1',
      group: 'Warehouse Specific',
    },
    snowplow__consent_cmp_visible: {
      ...
      longDescription: 'The table name for your CMP Visible event.',
      packageDefault: 'com_snowplowanalytics_snowplow_cmp_visible_1',
      group: 'Warehouse Specific',
    },
    snowplow__consent_preferences: {
      ...
      longDescription: 'The table name for your Consent Preferences entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_consent_preferences_1',
      group: 'Warehouse Specific',
    },
    snowplow__cwv_context: {
      ...
      longDescription: 'The table name for your CWV events.',
      packageDefault: 'com_snowplowanalytics_snowplow_web_vitals_1',
      group: 'Warehouse Specific',
    },
