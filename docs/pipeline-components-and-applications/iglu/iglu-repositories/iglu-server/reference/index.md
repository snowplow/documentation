...
| `patchesAllowed` | Optional. Default: `false`. If `true`, allows overwriting a given version of a schema with new content. See [amending schemas](/docs/data-product-studio/versioning-your-data-structures/amending/index.md). |
