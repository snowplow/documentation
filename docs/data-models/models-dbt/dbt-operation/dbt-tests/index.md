...
This is our recommended approach to testing and can be implemented using the selector flag (see [YAML selectors](/docs/data-models/models-dbt/dbt-operation/index.md#yaml-selectors) section for more details) as follows:
