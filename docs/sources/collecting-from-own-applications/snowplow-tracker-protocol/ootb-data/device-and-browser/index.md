...
[See the JavaScript tracker documentation](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/index.md#auto-tracked-entities) to learn how to configure the context entity.
...
* [iOS and Android tracker](/docs/sources/collecting-from-own-applications/mobile-trackers/tracking-events/platform-and-application-context/index.md#platform-context).
* [React Native tracker](/docs/sources/collecting-from-own-applications/react-native-tracker/tracking-events/platform-and-application-context/index.md#platform-context).
...
[YAUAA (Yet Another User Agent Analyzer) enrichment](/docs/pipeline/enriching-your-data/available-enrichments/yauaa-enrichment/index.md) enables parsing the user-agent string tracked in Web events.
...
The [IAB Spiders & Robots enrichment](/docs/pipeline/enriching-your-data/available-enrichments/iab-enrichment/index.md) uses the IAB/ABC International Spiders and Bots List to determine whether an event was produced by a user or a robot/spider based on its’ IP address and user agent.
