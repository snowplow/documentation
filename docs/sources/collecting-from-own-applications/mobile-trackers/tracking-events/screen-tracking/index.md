...
- The tracker automatically tracks each screen change using a [`ScreenView` event](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/ootb-data/page-and-screen-view-events/#screen-view-events).
...
This information is attached using a [`screen_summary` context entity](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/ootb-data/page-activity-tracking/index.md#screen-summary-entity) to the following events:
