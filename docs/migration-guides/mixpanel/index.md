...
The Snowplow CLI includes an [MCP server](/docs/llms-support/cli-mcp-server/index.md) to help you translate your Mixpanel Tracking Plans into Snowplow tracking plans.
:::
...
You'll need to translate your Mixpanel Tracking Plans into Snowplow [tracking plans](/docs/fundamentals/tracking-plans/index.md). Some things to consider:
