...
The emitter to which the tracker will send events. See [Emitters](/docs/sources/collecting-from-own-applications/java-tracker/configuring-how-events-are-sent/index.md) for more on emitter configuration.
...
For a full list of supported platforms, please see the [Snowplow Tracker Protocol](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/index.md#common-parameters).
