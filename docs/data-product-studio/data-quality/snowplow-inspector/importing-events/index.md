...
In the main Events view, the Timeline down the side allows you to import events from other devices that you can view as if your own browser generated them.
The options are available via the "Import Events" button, and detailed below.
...
You can export the current contents of the "Network" panel in your DevTools to a HAR file, and then later load them into the extension as a record that events fired and successfully validated (or not).
