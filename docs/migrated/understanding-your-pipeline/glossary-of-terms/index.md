...
__[Read more](/docs/migrated/getting-started-on-snowplow-open-source/setup-snowplow-on-aws/setting-up-your-aws-environment/)__
...
__[Read more](/docs/migrated/collecting-data/)__
...
__[Read more](/docs/migrated/pipeline-components-and-applications/iglu/)__
...
__[Read more](/docs/migrated/understanding-your-pipeline/)__
...
__[Read more](/docs/migrated/understanding-tracking-design/versioning-your-data-structures/)__
...
__[Read more](/docs/migrated/pipeline-components-and-applications/loaders-storage-targets/snowplow-rdb-loader/rdb-shredder/)__
...
__[Read more](/docs/migrated/getting-started-on-snowplow-open-source/setup-snowplow-on-aws/setup-destinations/)__
...
__[Read more](/docs/migrated/understanding-your-pipeline/canonical-event/)__

### Tracker

A tracker is client- or server-side libraries which track customer behaviour by sending Snowplow events to a Collector.

__[Read more](/docs/migrated/collecting-data/collecting-from-own-applications/)__
...
__[Read more](/docs/migrated/collecting-data/collecting-data-from-third-parties/)__
