...
- **Application IDs**: the [Application IDs](/docs/event-studio/source-applications/#application-ids) expected to be used for this application. _These will automatically flow down to the tracking plans and Event specifications you define relating to this Source Application._
