...
Note: this tracker should not be used to track exceptions happening in tracker itself, use [callbacks](/docs/sources/scala-tracker/previous-versions/0-5-0/initialization/index.md#callbacks) mechanism for that.
