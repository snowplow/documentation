...
You can find more detail on setting up a source, in the [configuration section](/docs/destinations/event-streaming/forwarding-events/snowbridge/configuration/sources/index.md).