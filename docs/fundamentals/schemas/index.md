...
Check out the documentation for [managing](/docs/data-product-studio/data-products/data-structures/manage/index.md) and [versioning](/docs/data-product-studio/data-products/data-structures/version-amend/index.md) data structures.
...
:::info
BDP customers can create custom schemas using the [Data Structures Builder](/docs/data-product-studio/data-products/data-structures/manage/ui/builder/index.md) without worrying about how it works under the hood.
:::
...
- **“version”** - Snowplow allows you to [increment versions of a schema](/docs/data-product-studio/data-products/data-structures/version-amend/index.md) as your tracking needs to evolve and this argument stores the current version.
...
**“$supersedes”** / **“$supersededBy”** - _Optional, not shown_. See [marking schemas as superseded](/docs/data-product-studio/data-products/data-structures/version-amend/amending/index.md#marking-the-schema-as-superseded).
