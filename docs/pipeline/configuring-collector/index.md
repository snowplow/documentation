...
![This image has an empty alt attribute; its file name is image-1.png](/img/docs/console-collector-config/image-1.png)
...
![This image has an empty alt attribute; its file name is image-2.png](/img/docs/console-collector-config/image-2.png)
...
![This image has an empty alt attribute; its file name is image-3.png](/img/docs/console-collector-config/image-3.png)
...
![This image has an empty alt attribute; its file name is image-4.png](/img/docs/console-collector-config/image-4.png)
