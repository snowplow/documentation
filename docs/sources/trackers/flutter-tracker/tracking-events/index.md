...
Page view events are the basic building blocks for the [Snowplow Unified data model](/docs/data-models/models-dbt/dbt-models/dbt-unified-data-model/index.md).
