...
Note: this tracker should not be used to track exceptions happening in tracker itself, use [callbacks](/docs/collecting-data/collecting-from-own-applications/scala-tracker/previous-versions/0-5-0/initialization/index.md#callbacks) mechanism for that.
