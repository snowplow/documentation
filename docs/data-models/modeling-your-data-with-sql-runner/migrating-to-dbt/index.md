...
We recommend you take a look at the [docs](/docs/data-models/modeling-your-data-with-dbt/index.md) for our dbt packages to get a better understanding of how they work and how you can use them going forward.
...
The latest information for our packages can be found in the [quickstart](/docs/data-models/modeling-your-data-with-dbt/dbt-quickstart/index.md) section of our docs. It is highly recommended you just start running your dbt project from scratch and process all data from the start date to ensure the package works as intended and all your data is processed in the same way.
