...
In Snowplow BDP, you can use the [data structures builder UI](/docs/data-product-studio/data-products/data-structures/manage/ui/builder/index.md) to follow along. You will not need the JSON code.
...
For this step, follow the documentation on [managing your data structures](/docs/data-product-studio/data-products/data-structures/manage/index.md).
