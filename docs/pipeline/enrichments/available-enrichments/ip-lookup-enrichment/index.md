...
Alternatively, you can [set up Micro to receive external IP addresses](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/remote-usage/index.md#exposing-micro-via-a-public-domain-name).
