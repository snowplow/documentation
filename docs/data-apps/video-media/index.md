...
Our **Video and Media Analytics** app helps you visualize insights on your video, audio and streaming content, based on data generated by our media plugins and [Media Player DBT package](docs/data-models/models-dbt/dbt-models/dbt-media-player-data-model/index.md). It comes with the following dashboards:
...
- Running the [Snowplow Media dbt Package](docs/data-models/models-dbt/dbt-models/dbt-media-player-data-model/index.md)
