...
| --- | --- | --- | --- |
| [`emitter`](/docs/sources/collecting-from-own-applications/unity-tracker/emitter/index.md) | The Emitter object you create | Yes | Null |
| `trackerNamespace` | The name of the tracker instance | Yes | Null |
| `appId` | The application ID | Yes | Null |
| [`subject`](/docs/sources/collecting-from-own-applications/unity-tracker/subject/index.md) | The Subject that defines a user | No | Null |
| [`session`](/docs/sources/collecting-from-own-applications/unity-tracker/session/index.md) | The Session object you create | No | Null |
