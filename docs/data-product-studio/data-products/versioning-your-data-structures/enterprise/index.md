...
Should you wish to use the middle versioning digit this is possible [via the Data Structures API](/docs/data-product-studio/data-products/managing-your-data-structures/api/index.md).
