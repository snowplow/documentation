...
Partnered with other tools like our [CI tool](/docs/managing-data-quality/using-the-data-structures-ci-tool-for-data-quality/) and / or [Snowplow Micro](/docs/managing-data-quality/testing-changes-to-your-pipeline/testing-with-snowplow-micro/), it's possible to have a very robust and automated data structure workflow that ensures data quality upstream of data hitting your pipeline.
