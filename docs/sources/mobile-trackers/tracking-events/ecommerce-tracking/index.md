...
The Snowplow ecommerce tracking APIs enable you to track events from your ecommerce store on the [web](/docs/sources/web-trackers/tracking-events/ecommerce/index.md) as well as mobile apps. A complete setup journey, including data modeling and visualization, is showcased in the [Ecommerce Accelerator](https://snowplow.io/data-product-accelerators/ecommerce-analytics-dpa/).
...
Each ecommerce event is a [self-describing](/docs/sources/mobile-trackers/custom-tracking-using-schemas/index.md) event using a single schema,
