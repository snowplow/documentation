...
As explained in [Introduction to tracking design](/docs/event-studio/index.md), to use Snowplow successfully, you need to have a good idea of:
...
:::info
Snowplow provides both a UI and an API to manage your Event Specifications. For information about managing event specifications see [How to manage Event Specifications](/docs/event-studio/event-specifications/index.md).
:::
