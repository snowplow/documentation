...
Snowplow is primarily built for data warehouse and lake destinations and supports Redshift, BigQuery, Snowflake, Databricks and Synapse Analytics, as well as S3, GCS and ADLS, via the [various loaders](/docs/storing-querying/storage-options/index.md).
