...
| `patchesAllowed` | Optional. Default: `false`. If `true`, allows overwriting a given version of a schema with new content. See [amending schemas](/docs/event-studio/data-structures/versioning/amending/index.md). |
