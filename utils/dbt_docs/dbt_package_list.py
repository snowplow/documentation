# List all packages and their snowplow org github repo name
# Note that for the reference docs order is important, the lowest level package (get used by others) should be earlier in the list.
all_packages = [
