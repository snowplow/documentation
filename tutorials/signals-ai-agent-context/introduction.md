...
Signals computes the session attributes from real events flowing through your pipeline. If you don't have one, you can deploy and use a [free 14-day Signals trial](https://signals.snowplow.io/start) to follow along.
:::
