...
See [here](/docs/pipeline-components-and-applications/iglu/iglu-resolver.md) for details on how to prepare the Iglu resolver file.
...
For more examples on running EMR jobs with Dataflow Runner, as well as details on cluster configurations and playbooks, see the app's [documentation](/docs/pipeline-components-and-applications/dataflow-runner.md). It also details how you can submit steps to a persistent EMR cluster.
