...
The emitter to which the tracker will send events. See [Emitters](/docs/collecting-data/collecting-from-own-applications/net-tracker/emitter/index.md) for more on emitter configuration.
