...
To learn more about configuring how events are sent, check out [this page](/docs/sources/collecting-from-own-applications/roku-tracker/configuration/index.md).
...
Check out the [example Roku channel](/docs/sources/collecting-from-own-applications/roku-tracker/example-app/index.md) to see the tracker used with Snowplow Micro.
