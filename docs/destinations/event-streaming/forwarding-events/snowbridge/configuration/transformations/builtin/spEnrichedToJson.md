...
The transformation to JSON is done via the [analytics SDK](/docs/destinations/event-streaming/analytics-sdk/index.md) logic, specifically in this case the [Golang analytics SDK](/docs/destinations/event-streaming/analytics-sdk/analytics-sdk-go/index.md).
