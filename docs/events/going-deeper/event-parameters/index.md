...
If enabled, the [activity tracking function](/docs/sources/web-trackers/tracking-events/index.md#activity-tracking-page-pings) checks for engagement with a page after load. (E.g. mousemovement, scrolling etc...).
