...
keywords: ["Web Events", "Event Tracking", "Web Analytics", "Behavior Tracking", "User Events", "Web Tracking"]
date: "2022-08-30"
...
For example, instrumenting a tracker and manually tracking a [page view](/docs/sources/trackers/web-trackers/tracking-events/page-views/index.md). Note that [activity tracking](/docs/sources/trackers/web-trackers/tracking-events/activity-page-pings/index.md) (page pings) is also configured here.
...
| [`clientHints`](/docs/sources/trackers/web-trackers/tracking-events/client-hints/index.md)         | Chrome user-agent Client Hints | `true`             |
...
Read about page view tracking [here](/docs/sources/trackers/web-trackers/tracking-events/page-views/index.md).
...
Read about how to track custom events [here](/docs/sources/trackers/web-trackers/custom-tracking-using-schemas/index.md).
...
The JavaScript Tracker automatically sets a `domain_userid` based on a first party cookie. Read more about cookies [here](/docs/sources/trackers/web-trackers/cookies-and-local-storage/index.md).
