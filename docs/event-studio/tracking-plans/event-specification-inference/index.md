...
- **Published**: the specification is active. The pipeline matches incoming events against it, attaches an `event_specification` entity to it, and surfaces [volume data and "last seen" timestamps](/docs/event-studio/tracking-plans/data-quality/index.md) in the Console.
