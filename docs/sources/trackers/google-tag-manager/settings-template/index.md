...
| `geolocation`                 | Information about the client's geolocation.                                                                                              | [Geolocation](/docs/snowplow-events/ootb-data/geolocation/index.md)                                                      |
| `session`                     | Information about the user session.                                                                                                      | [Session](/docs/snowplow-events/ootb-data/user-and-session-identification/index.md#client-session-context-entity)        |
