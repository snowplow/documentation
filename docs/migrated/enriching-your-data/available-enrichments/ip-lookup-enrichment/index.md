...
Snowplow BDP customers can enable the IP Lookup enrichment for your pipeline [in the Snowplow console.](/docs/migrated/enriching-your-data/configuring-enrichments/) Open Source will need to upload the enrichment json for use in their Snowplow pipeline.
