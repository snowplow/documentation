...
- All topics and subscriptions (`input`, `typesTopic`, `typesSubscription`, `badRows` and `failedInserts`) are explained in the [topics and message formats](/docs/destinations/warehouses-and-lakes/bigquery/previous-versions/bigquery-loader-0-3-0/index.md#topics-and-message-formats) section.
...
It is generally recommended to stick with the **streaming jobs** API without retries and use [Repeater](/docs/destinations/warehouses-and-lakes/bigquery/previous-versions/bigquery-loader-0-3-0/index.md#repeater) to recover data from `failedInserts`. However, the **load jobs** API is cheaper and generates fewer duplicates.
