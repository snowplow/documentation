...
sidebar_label: "Custom tracking using schemas"
date: "2022-03-24"
sidebar_position: 30
description: "Track custom events and add context entities using self-describing JSON schemas with Java tracker v0.12."
keywords: ["self-describing events v0.12", "custom context", "json schemas"]
---
...
JSON can be sent base-64 encoded or not. By default, they are encoded. This is set as part of the Tracker configuration. See [Setting up](/docs/sources/java-tracker/previous-versions/java-tracker-v0-12/installation-and-set-up/index.md#setting-up).
