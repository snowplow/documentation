...
While this recipe is still relevant if you want to process the raw data yourself, we recommend you use our [snowplow-web dbt package](/docs/data-models/models-dbt/dbt-models/legacy/dbt-web-data-model/index.md) instead now to do all this for you!
...
For more information on how Snowplow models web data, take a look at [our dbt web data model](/docs/data-models/models-dbt/dbt-models/legacy/index.md).
