---
title: "Add custom schemas to Snowplow Inspector"
sidebar_label: "Adding custom schemas"
sidebar_position: 10
description: "Configure Snowplow Inspector to access custom schemas from local registries, Data Structures API, Iglu Server, or static repositories. Validate events against private schemas by logging into Console or manually adding registries."
keywords: ["custom schemas", "iglu registries", "schema validation", "local registry", "data structures api"]
---

By default, the extension is able to see [Iglu schemas](/docs/fundamentals/schemas/index.md) for events and entities generated by the standard Snowplow [tracker](/docs/sources/index.md) and plugin APIs, as they're publicly available on the public [Iglu Central](/docs/api-reference/iglu/iglu-repositories/index.md#iglu-central) registry.
...
- Iglu API key: see [API keys and the authentication service](/docs/api-reference/iglu/iglu-repositories/iglu-server/setup/index.md#3-use-the-api-key-generation-service) for instructions on generating an Iglu API key.
