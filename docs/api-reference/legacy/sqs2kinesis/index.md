...
It is superseded by [Snowbridge](/docs/destinations/event-streaming/forwarding-events/snowbridge/index.md), which provides the same functionality via its [SQS source](/docs/destinations/event-streaming/forwarding-events/snowbridge/configuration/sources/sqs.md) and [Kinesis target](/docs/destinations/event-streaming/forwarding-events/snowbridge/configuration/targets/kinesis.md).
