...
To learn more about configuring how events are sent, check out [this page](/docs/migrated/collecting-data/collecting-from-own-applications/roku-tracker/configuration/).
...
Check out the [example Roku channel](/docs/migrated/collecting-data/collecting-from-own-applications/roku-tracker/example-app/) to see the tracker used with a Snowplow Micro.
