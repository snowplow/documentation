...
This migration guide is for the [Snowplow Web](/docs/data-models/modeling-your-data-with-dbt/dbt-models/legacy/dbt-web-data-model/index.md) (legacy dbt package) users who would like to upgrade to the [Snowplow Unified Digital](/docs/data-models/modeling-your-data-with-dbt/dbt-models/dbt-unified-data-model/index.md) package which is our most supported and feature-rich dbt package you can use to model web and/or mobile event data.
...
```
For more on this, have a look at the [passthrough fields](/docs/data-models/modeling-your-data-with-dbt/package-features/passthrough-fields/index.md) section.
