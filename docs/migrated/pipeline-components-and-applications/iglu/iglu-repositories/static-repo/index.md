...
A static repo is simply an Iglu repository server structured as a static website. [Iglu Central](/docs/migrated/pipeline-components-and-applications/iglu/iglu-central-setup/) can be used as an example, [serving](http://iglucentral.com/) its whole content over http.
...
For details on how to do this, check out the page on [Iglu client configuration](/docs/migrated/pipeline-components-and-applications/iglu/iglu-resolver/).
