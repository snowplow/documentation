...
If you are unsure whether the default values set are good enough in your case or you would already like to maximize the potential of your models, you can dive deeper into the meaning behind our variables on our [Config](/docs/data-models/models-dbt/dbt-configuration/unified/) page. It includes a [Config Generator](/docs/data-models/models-dbt/dbt-configuration/unified/#Generator) to help you create all your variable configurations, if necessary.


### 10. Run your model

You can now run your models for the first time by running the below command (see the [operation](/docs/data-models/models-dbt/dbt-operation/index.md) page for more information on operation of the package):
