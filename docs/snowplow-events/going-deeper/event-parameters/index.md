...
To learn about self-describing events and how they are serialized in the tracker payload, [visit this page](/docs/snowplow-events/custom-events/self-describing-events/index.md).
...
To learn about context entities and how they are serialized in the event payload, [visit this page](/docs/snowplow-events/custom-events/context-entities/index.md).
