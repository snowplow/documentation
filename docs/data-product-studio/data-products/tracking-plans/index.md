...
As explained in [Introduction to tracking design](/docs/data-product-studio/data-products/introduction-to-tracking-design/index.md), to use Snowplow successfully, you need to have a good idea of:
...
:::info
Snowplow BDP provides both a UI and an API to manage your Event Specifications. For information about managing event specifications see [How to manage Event Specifications](/docs/data-product-studio/data-products/managing-event-specifications/index.md).
:::