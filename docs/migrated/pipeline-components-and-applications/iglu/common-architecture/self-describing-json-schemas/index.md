...
- `version` which is the JSON Schema's version (using [SchemaVer](/docs/migrated/pipeline-components-and-applications/iglu/schemaver/))
...
To make our JSONs self-describing we still have to reference this JSON Schema in our JSONs. This process is described in [Self-describing JSONs](/docs/migrated/pipeline-components-and-applications/iglu/common-architecture/self-describing-jsons/).
