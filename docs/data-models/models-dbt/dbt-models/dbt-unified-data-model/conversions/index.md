...
You can use the below generator to generate the conversion events variable, make sure you combine this with existing conversions if you have any already. You can also use the full config generator on the [configuration page](/docs/data-models/models-dbt/dbt-configuration/unified/index.mdx) to help you generate all your package variables.
