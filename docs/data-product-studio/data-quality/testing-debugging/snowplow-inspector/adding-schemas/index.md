...
This type is recommended for use with Snowplow BDP via the [Data Structures API](/docs/data-product-studio/data-products/data-structures/manage/api/index.md).
