...
<tr>
    ...
    <td>Optional. Either <code>pubsub</code> or <code>file</code>, default value <code>file</code>. Type of bad output sink. When <code>file</code>, badrows are written as files under URI configured in <code>output.path</code>.</td>
</tr>
<tr>
