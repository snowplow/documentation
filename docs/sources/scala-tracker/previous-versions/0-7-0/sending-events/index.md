...
description: "Track self-describing events, structured events, page views, errors, and ecommerce transactions in Scala tracker 0.7.0 with circe JSON and SchemaKey."
keywords: ["scala 0.7 events", "self-describing events", "circe json"]
---
...
Note: this tracker should not be used to track exceptions happening in tracker itself, use [callbacks](/docs/sources/scala-tracker/previous-versions/0-7-0/initialization/index.md#callbacks) mechanism for that.
