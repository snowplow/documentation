...
| `os_timezone`         | text      | Client operating system timezone                                                                                                                                             | No    | 'Europe/London'           | Tracking: [Timezone Plugin](/docs/sources/web-trackers/tracking-events/timezone-geolocation/index.md) | ✅   | ✅      |
