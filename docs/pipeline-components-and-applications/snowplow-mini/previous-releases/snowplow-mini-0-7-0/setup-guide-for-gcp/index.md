...
imported-sp-mini \
--source-uri \
https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-large-1579519439.tar.gz
```
...
| --- | --- | --- |
| [large](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-large-1579519439.tar.gz) | [xlarge](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-xlarge-1579518985.tar.gz) | [xxlarge](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-xxlarge-1579520253.tar.gz) |
...
### [](https://github.com/snowplow/snowplow-mini/wiki/Setup-guide-GCP---0.7.0#large--xlarge--xxlarge)large & xlarge & xxlarge
...
If you want, you can download [`large`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-large-1579519439.tar.gz) , [`xlarge`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-xlarge-1579518985.tar.gz) and [`xxlarge`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-7-0-xxlarge-1579520253.tar.gz) for other usages/purposes.
