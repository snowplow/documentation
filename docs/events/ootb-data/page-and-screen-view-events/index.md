...
We recommend using the [Base web tracking plan template](/docs/data-product-studio/data-products/data-product-templates/index.md#base-web) for web tracking. It includes page views.
...
We recommend using the [Base mobile tracking plan template](/docs/data-product-studio/data-products/data-product-templates/index.md#base-mobile) for mobile tracking. It includes screen views.
