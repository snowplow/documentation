...
Self-describing (self-referential) JSON schemas are at the core of Snowplow tracking. Read more about them [here](/docs/migrated/understanding-tracking-design/understanding-schemas-and-validation/). They allow you to track completely customised data, and are also used internally throughout Snowplow pipelines.
...
Event context is sent as a JSON inside the event payload. During [enrichment](/docs/migrated/enriching-your-data/what-is-enrichment/), it is separated into columns for each different schema used.
...
JSON can be sent base-64 encoded or not. By default, they are encoded. This is set as part of the Tracker configuration. See [Setting up](/docs/migrated/collecting-data/collecting-from-own-applications/java-tracker/installation-and-set-up/#setting-up).
