...
The emitter to which the tracker will send events. See [Emitters](/docs/migrated/collecting-data/collecting-from-own-applications/java-tracker/emitter/) for more on emitter configuration.
...
For a full list of supported platforms, please see the [Snowplow Tracker Protocol](/docs/migrated/collecting-data/collecting-from-own-applications/snowplow-tracker-protocol/#Common_parameters_platform_and_event_independent).
