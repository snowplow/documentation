...
Find the documentation for both in the [Web trackers](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/index.md) section.

### Server-side tracking
Track events in server-side Node.js environments using the **Node.js Tracker (v3)**. Used via npm.

Find the documentation in the [Node.js tracker](/docs/sources/collecting-from-own-applications/javascript-trackers/node-js-tracker/index.md) section.
