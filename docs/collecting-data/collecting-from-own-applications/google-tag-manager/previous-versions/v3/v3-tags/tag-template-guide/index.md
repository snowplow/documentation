...
The Tag template requires a [Snowplow v3 Settings](/docs/collecting-data/collecting-from-own-applications/google-tag-manager/previous-versions/v3/v3-settings-variable/index.md) Variable to be configured. This variable contains the information required for the Tag to appropriately initialize the tracker.
