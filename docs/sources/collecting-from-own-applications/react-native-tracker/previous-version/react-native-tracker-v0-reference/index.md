...
This documentation page is about a previous version of the React Native tracker. [Go to the latest docs](/docs/sources/collecting-from-own-applications/react-native-tracker/index.md).
...
See also the official [Snowplow mobile data model](/docs/data-models/modeling-your-data-with-dbt/dbt-models/legacy/dbt-mobile-data-model/index.md)!
