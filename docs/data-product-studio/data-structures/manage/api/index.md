...
As well as managing [data structures](/docs/fundamentals/schemas/index.md) through the Snowplow Console, Snowplow customers can also manage them programmatically through the data structures API.
