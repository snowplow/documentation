...
- **“version”** - Snowplow allows you to [increment versions of a schema](/docs/migrated/understanding-tracking-design/versioning-your-data-structures/) as your tracking needs evolve and this argument stores the current version.
