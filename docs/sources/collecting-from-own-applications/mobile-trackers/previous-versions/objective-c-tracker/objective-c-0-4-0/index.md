...
Assuming you have completed the [iOS Tracker Setup](/docs/sources/collecting-from-own-applications/mobile-trackers/installation-and-set-up/index.md?platform=ios#installing) for your project, you are now ready to initialize the Snowplow Tracker.
