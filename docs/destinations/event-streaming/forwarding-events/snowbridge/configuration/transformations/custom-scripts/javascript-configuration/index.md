...
If a script errors or times out, a [transformation failure](/docs/destinations/event-streaming/forwarding-events/snowbridge/concepts/failure-model/index.md#transformation-failure) occurs.
