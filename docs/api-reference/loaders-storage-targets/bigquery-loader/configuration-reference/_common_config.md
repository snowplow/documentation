...
<tr>
    ...
    <td>Optional. Setting any tag enables the loader's Prometheus scrape endpoint, served on the health probe port. A map of key/value pairs added as common labels on every Prometheus metric.</td>
</tr>
<tr>
