...
| [UA Parser (legacy)](/docs/pipeline/enrichments/available-enrichments/ua-parser-enrichment/index.md)                     | Parse the user agent string and attach an entity with detailed user agent information. YAUAA enrichment is preferred.                            |
