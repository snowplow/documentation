...
Snowplow events have a defined structure and protocol that is identical regardless of the tracker used. Further information on this structure can be found [here](/docs/snowplow-events/index.md). 
...
More detail on the `Subject` class can be found [here](/docs/sources/trackers/python-tracker/subject/index.md). 
