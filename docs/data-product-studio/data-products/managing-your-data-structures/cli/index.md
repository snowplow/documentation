...
3. Given the organization's [loading configuration](/docs/destinations/loaders-warehouses/loading-process/) will any schema version number choices have a potentially negative effect on data loading
