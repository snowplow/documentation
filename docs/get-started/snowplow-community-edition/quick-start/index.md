...
For an out-of-the-box solution to accessing this data in real-time streams, you can [check out our Snowbridge tool](/docs/destinations/event-streaming/forwarding-events/snowbridge/index.md). Alternatively, if you want to develop a custom consumer, you can [leverage our Analytics SDKs](/docs/destinations/event-streaming/analytics-sdk/index.md) to parse the event formats more easily.
