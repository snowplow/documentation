...
The identifiers are either added in the [atomic event properties](/docs/fundamentals/canonical-event/index.md#user-fields) or as a [client session entity](/docs/events/ootb-data/user-and-session-identification/index.md).
