...
**On the configuration screen**, edit the JSON configuration ([refer to each individual enrichments documentation for support](/docs/pipeline/enriching-your-data/available-enrichments/index.md)) and click _Validate._
