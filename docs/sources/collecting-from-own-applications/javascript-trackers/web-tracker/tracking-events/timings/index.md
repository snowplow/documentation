...
You can also create and track general timing events using the [site tracking plugin](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/timings/generic/index.md).
