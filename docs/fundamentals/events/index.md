...
You can create all of these by using various [tracking SDKs](/docs/sources/collecting-from-own-applications/index.md).
...
Snowplow [tracking SDKs](/docs/sources/collecting-from-own-applications/index.md) provide a dedicated API for these events. For example, if you want to track a page view using the [JavaScript tracker](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/quick-start-guide/index.md):
...
To track a structured event, use one of the [tracking SDKs](/docs/sources/collecting-from-own-applications/index.md). For example, with the [JavaScript tracker](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/quick-start-guide/index.md):
...
To track your own _custom_ self-describing event, e.g. `viewed_product`, **you will first need to define its [schema](/docs/fundamentals/schemas/index.md)** (see [managing data structures](/docs/data-product-studio/data-products/managing-your-data-structures/index.md)). This schema might have fields such as `productId`, `brand`, etc.

Then you can use one of our [tracking SDKs](/docs/sources/collecting-from-own-applications/index.md). For example, with the [JavaScript tracker](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/quick-start-guide/index.md):
