...
`iglu-ruby-client` gem also provides entities specific to [Iglu core's](/docs/migrated/pipeline-components-and-applications/iglu/common-architecture/iglu-core/).  
...
Ruby Client supports somewhat similar to [JVM embedded](/docs/migrated/pipeline-components-and-applications/iglu/iglu-repositories/jvm-embedded-repo/) registry.  
