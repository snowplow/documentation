...
- Use igluctl 0.7.0's `[server keygen](/docs/migrated/open-source-components-and-applications/iglu/igluctl-0-7-0/#server_keygen)` subcommand
...
- Use igluctl [static push](/docs/migrated/open-source-components-and-applications/iglu/igluctl-0-7-0/#static_push) to put our custom schema into the Iglu Server
- Use any HTTP client e.g. cURL
