...
import ParquetRecoveryColumns from '@site/docs/destinations/loaders-warehouses/schemas-in-warehouse/_parquet-recovery-columns.md';
```
...
What happens when you evolve your schema to a [new version](/docs/data-product-studio/data-products/versioning-your-data-structures/index.md)?
...
If you are [modeling your data with dbt](/docs/data-models/modeling-your-data-with-dbt/index.md), you can use [this macro](https://github.com/snowplow/dbt-snowplow-utils#combine_column_versions-source) to aggregate the data across multiple columns.
