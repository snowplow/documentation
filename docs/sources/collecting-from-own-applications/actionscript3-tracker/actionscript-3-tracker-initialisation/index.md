...
Assuming you have completed the [Actionscript 3 Tracker Setup](/docs/sources/collecting-from-own-applications/actionscript3-tracker/setup/index.md) for your project, you are now ready to initialize the AS3 Tracker.
...
The emitter to which the tracker will send events. See [Emitters](/docs/sources/collecting-from-own-applications/actionscript3-tracker/sending-event-emitter/index.md) for more on emitter configuration.
...
For a full list of supported platforms, please see the [Snowplow Tracker Protocol](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/index.md).
