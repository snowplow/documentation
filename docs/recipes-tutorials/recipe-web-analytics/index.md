...
While this recipe is still relevant if you want to process the raw data yourself, we recommend you use our [snowplow-web dbt package](/docs/data-models/modeling-your-data-with-dbt/dbt-models/legacy/dbt-web-data-model/index.md) instead now to do all this for you!
...
Go ahead and update the sessionization logic in your tracker implementation if you would like to. More information on the Snowplow session cookie can be found [here](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/cookies-and-local-storage/index.md).
...
For more information on how Snowplow models web data, take a look at [our dbt web data model](/docs/data-models/modeling-your-data-with-dbt/dbt-models/legacy/index.md).
