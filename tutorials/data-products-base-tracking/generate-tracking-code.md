...
![VS Code file explorer showing the src/tracking directory containing .snowtype-lock.json, instructions.md, and snowplow.ts generated by Snowtype](./images/fs.png)
...
![Snowplow Inspector showing a todo_action self-describing event with the Entities panel open, displaying the todo entity (title: Test), event_specification entity (name: "Add todo", data_product_name: "Todo - Goals"), and web_page entity](./images/inspector-spec.png)

After a while the Event Specification volume counts for each event will be available at the tracking plans screen.

![Todo - Goals tracking plan showing event specifications Add todo, Complete todo, and Remove todo — all using todo_action 2-0-0 with a volume of 5 events each as of 14 Sept 2024](./images/custom-dp-volumes.png)
