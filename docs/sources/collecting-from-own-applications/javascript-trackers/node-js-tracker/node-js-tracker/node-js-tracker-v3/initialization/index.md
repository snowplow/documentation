...
Assuming you have completed the [Node.js Tracker Setup](/docs/sources/collecting-from-own-applications/javascript-trackers/node-js-tracker/node-js-tracker-v4/setup/index.md) for your project, you are now ready to initialize the Tracker.
...
interface Emitter {
  ...
  /** Set if the requests from the emitter should be anonymized. Read more about anonymization used at https://docs.snowplow.io/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/going-deeper/http-headers/. Available from 3.21.0 onwards */
