...
The most basic Tracker instance will only require you to provide an [Emitter](/docs/sources/php-tracker/emitters/index.md) and the data [Subject](/docs/sources/php-tracker/subjects/index.md) for which the Tracker will log events.
