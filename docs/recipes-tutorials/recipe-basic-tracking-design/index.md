...
In Snowplow BDP, you can use the [data structures builder UI](/docs/data-product-studio/data-products/managing-your-data-structures/ui/builder/index.md) to follow along. You will not need the JSON code.
...
If you set it to `true`, the events will pass validation, but they will not be stored in your data warehouse (unless you are using Snowflake — see [how schemas translate to the warehouse](/docs/destinations/loaders-warehouses/schemas-in-warehouse/index.md)).
...
For this step, follow the documentation on [managing your data structures](/docs/data-product-studio/data-products/managing-your-data-structures/index.md).
...
- Use [Snowplow Micro](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/index.md) or [Snowplow Mini](/docs/api-reference/snowplow-mini/overview/index.md) to validate our tracking
...
Follow the Web Quick Start Guide to [add it into your HTML](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/quick-start-guide/index.md).
...
The easiest way to test that your tracking works correctly is via the [Snowplow Inspector](/docs/data-product-studio/data-quality/testing-debugging/snowplow-inspector/index.md). Make sure to [configure](/docs/data-product-studio/data-quality/testing-debugging/snowplow-inspector/adding-schemas/index.md) it with your schema registry.

With Snowplow BDP, you can use [Snowplow Mini](/docs/api-reference/snowplow-mini/index.md) to validate _and_ inspect your events in more detail in the OpenSearch dashboard.

Finally, regardless of your Snowplow offering, you can also use [Snowplow Micro](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/index.md).
