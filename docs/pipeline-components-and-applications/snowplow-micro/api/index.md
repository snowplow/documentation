...
- `schema`: corresponds to the schema of a [self-describing event](/docs/understanding-your-pipeline/events/#self-describing-events) (schema of the self-describing JSON contained in `ue_pr` or `ue_px`). It automatically implies `event_type` = `ue`.
