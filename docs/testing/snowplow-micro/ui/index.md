...
If you are [running Micro through Console](/docs/testing/snowplow-micro/console/index.md), navigate to the **Pipelines** side menu and select your Micro. Then click **Open dashboard**. You will need the _View environments_ permission to access the UI.
