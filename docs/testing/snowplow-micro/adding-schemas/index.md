...
* **Point Micro to an Iglu registry that contains your schemas.** This is a good option if you use Snowplow [Console](/docs/event-studio/data-structures/index.md) UI or [API](/docs/event-studio/programmatic-management/data-structures-api/index.md) to create schemas, or if you have deployed your own Iglu registry.
