---
title: "Iglu Server HOCON configuration reference"
sidebar_label: "Configuration reference"
date: "2021-08-03"
sidebar_position: 0
description: "Complete HOCON configuration reference for Iglu Server including database, API, webhooks, and thread pool settings."
keywords: ["iglu server config", "hocon", "iglu configuration", "iglu server settings"]
---
...
Iglu Server is released under the [Snowplow Limited Use License](/limited-use-license-1.1/) ([FAQ](/docs/resources/limited-use-license-faq/index.md)).
