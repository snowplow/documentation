...
3. Configure and run the collector, using the main [collector documentation](/docs/collecting-data/stream-collector/index.md), which describes the core concepts of how the collector works, and the configuration options.
