...
![Data products page with the suggested data product templates panel open, showing E-commerce Web, Base Web, Media Web, and Base Mobile template options](./images/create-dp.png)
...
!["Edit data product information" modal for the Todo - Base Web tracking plan with "Todo Web Application" selected as the source application](./images/create-base-dp-inputs.png)
