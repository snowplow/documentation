...
If you want to use this as a [failure target](/docs/destinations/event-streaming/forwarding-events/snowbridge/concepts/failure-model/index.md#failure-targets), then use failure_target instead of target.
