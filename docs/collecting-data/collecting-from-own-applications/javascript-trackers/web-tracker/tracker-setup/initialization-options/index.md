...
| [`stateStorageStrategy`](/docs/collecting-data/collecting-from-own-applications/javascript-trackers/web-tracker/cookies-and-local-storage/configuring-cookies/#storage-strategy)                                                                                                                                                                        | How to store tracker state.                                                                          | 1                       | `string` enum |
