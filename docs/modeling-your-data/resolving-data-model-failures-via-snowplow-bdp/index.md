...
Please note this documentation assumes you are running your data models via the data modeling UI in Snowplow BDP Console, as described in [the documentation for configuring and running data models via Snowplow BDP](/docs/modeling-your-data/configuring-and-running-data-models-via-snowplow-bdp/#21_Configuring_data_models_via_the_data_modeling_UI_new).
