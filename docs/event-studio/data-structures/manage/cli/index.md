...
The `data-structures` subcommand of [Snowplow CLI](/docs/event-studio/snowplow-cli/index.md) provides a collection of functionality to ease the integration of custom development and publishing workflows.

## Snowplow CLI Prerequisites

Installed and configured [Snowplow CLI](/docs/event-studio/snowplow-cli/index.md)
