...
Snowplow Mini is similar to [Snowplow Micro](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/what-is-micro/index.md), with the following differences:
