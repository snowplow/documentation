...
The events are: `OpenWindowEvent`, `DismissWindowEvent`, `OpenImmersiveSpaceEvent`, and `DismissImmersiveSpaceEvent`. Find the schema details for the events and entities [here](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/ootb-data/visionos-swiftui/index.md).
...
In this example, a window group entity is added to an [Ecommerce](docs/sources/collecting-from-own-applications/mobile-trackers/tracking-events/ecommerce-tracking/index.md) `ProductViewEvent`.
...
Read more about customized tracking [here](docs/sources/collecting-from-own-applications/mobile-trackers/custom-tracking-using-schemas/index.md).
