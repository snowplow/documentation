...
- `snowplow_utils.type_string` it has been deprecated and should be replaced with `dbt.type_string()` for non-length specific calls, and `api.Column.string_type(n_chars)` for length-specific calls.
