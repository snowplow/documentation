...
You can find a guide to configuration in the [configuration section](/docs/destinations/event-streaming/forwarding-events/snowbridge/configuration/index.md), and a guide to deployment in the [deployment page](./distribution-and-deployment.md).
