...
| [Buttons](/docs/sources/web-trackers/tracking-events/button-click/index.md) and [forms](/docs/sources/web-trackers/tracking-events/form-tracking/index.md) | Track button clicks and form interactions on web         | Events                |                       |
| [Campaigns](/docs/sources/web-trackers/tracking-events/campaigns-utms/index.md) and [ads](/docs/sources/web-trackers/tracking-events/ads/index.md)         | Track marketing campaigns and ads on web                 | Atomic fields, events |                       |
...
| [Page elements](/docs/sources/web-trackers/tracking-events/element-tracking/index.md)                                                                      | Track page element visibility and lifecycle on web       | Events, entity        |                       |
