...
- **Observability phase**: monitor event specification usage directly in Console. See the total number of events collected for each specification, when each was last seen, and how many of those events were valid, inferred, had violations, or failed. This helps you confirm implementations are live, identify unused specifications, and find implementation problems. See [Monitor tracking plan data quality in Console](/docs/event-studio/tracking-plans/data-quality/index.md)
