...
If you're upgrading from Snowplow pre-R119 and S3 Loader pre-0.7.0 you have to [upgrade to 0.7.0](https://discourse.snowplowanalytics.com/t/s3-loader-0-7-0-google-cloud-storage-loader-0-3-1-released/3651) or 1.0.0 first in order to split bad data produced during transition period.
