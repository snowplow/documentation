...
If you have created Snowflake resources by following [this guide](/docs/getting-started-on-snowplow-open-source/quick-start-aws/index.md) and deployed the pipeline using the default or secure, you will have a Snowflake database where all of your enriched data is stored.
