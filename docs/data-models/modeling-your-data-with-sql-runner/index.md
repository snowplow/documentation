...
For any new developments we highly recommend using our [dbt packages](/docs/data-models/modeling-your-data-with-dbt/index.md) instead. SQL Runner is no longer under active development and will only receive bug fixes in the future.
