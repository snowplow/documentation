...
**2)** Read through the [rest of the documentation](/docs/sources/collecting-from-own-applications/arduino-tracker/index.md) for the Arduino Tracker to learn exactly what tracking capabilities Snowplow can provide for your Arduino sketch.
