...
We have built [snowplow-cli](/docs/data-product-studio/data-products/data-structures/manage/cli/) to help you bridge the gap between these repository based workflows and BDP Console.

## Prerequisites

* A deployed Snowplow BDP pipeline
* [snowplow-cli](/docs/data-product-studio/data-products/data-structures/manage/cli/#download) downloaded and configured
...
:::note
This directory layout and file naming scheme is also followed by the [download](/docs/data-product-studio/data-products/data-structures/manage/cli/#downloading-data-structures) command.
:::
...
* `meta.hidden` directly relates to showing and hiding [in BDP Console UI](/docs/data-product-studio/data-products/data-structures/manage/ui/#hiding-a-data-structure)
