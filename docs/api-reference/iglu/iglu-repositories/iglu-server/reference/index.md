...
| `patchesAllowed` | Optional. Default: `false`. If `true`, allows overwriting a given version of a schema with new content. See [amending schemas](/docs/data-product-studio/data-products/data-structures/version-amend/amending/index.md). |
