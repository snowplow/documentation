...
| Option | Value |
| --- | --- |
| **Name** (also see [Add DNS Record for bucket](/docs/collecting-data/collecting-from-own-applications/javascript-trackers/javascript-tracker/self-hosting-the-javascript-tracker/self-hosting-the-javascript-tracker-on-google-cloud.md#add-dns-record-for-bucket-optional)) | For example, `[company-name]-sp-js` |
