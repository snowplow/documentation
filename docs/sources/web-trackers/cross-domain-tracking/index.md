...
Configure [cross-domain tracking](/docs/events/cross-navigation/index.md) using the `crossDomainLinker` and `useExtendedCrossDomainLinker` fields of the [configuration object](/docs/sources/web-trackers/tracker-setup/initialization-options/index.md).
