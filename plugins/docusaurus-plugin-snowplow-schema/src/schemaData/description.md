...
description: "Troubleshoot and resolve dbt model failures in Snowplow for reliable behavioral data processing."

docs/modeling-your-data/running-data-models-via-snowplow-bdp/retrieving-job-execution-data-via-the-api/index.md
description: "Retrieve job execution data via Snowplow API for behavioral data model monitoring and debugging."
