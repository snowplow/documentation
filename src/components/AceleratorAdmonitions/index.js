...
export function Accelerator(props) {
  return (
    <Admonition icon={SnowplowIcon()} title="Unleash the power of your behavioral data" type="tip">
      ...
      <br/>
      <a className="navbar__item navbar__link snwpl-nav-button" href={props.href}>👉 Take me there! 👈</a>
    </Admonition>
  )
}
...
export function AllAccelerators(props) {
  return (
    <Admonition icon={SnowplowIcon()} title="Unleash the power of your behavioral data" type="tip">
      ...
      <br/>
      <a className="navbar__item navbar__link snwpl-nav-button" href="https://snowplow.io/data-product-accelerators/">👉 Take me there! 👈</a>
    </Admonition>
  )
}
