...
We recommend using the [Base web tracking plan template](/docs/data-product-studio/data-products/data-product-templates/index.md#base-web) for web tracking. It includes link clicks.
