...
- Users of Google Tag Manager can use the [Snowplow Analytics Custom Template](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracker-setup/google-tag-manager-custom-template/index.md).

- Use the Snowplow Plugin in the [analytics npm package](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracker-setup/snowplow-plugin-for-analytics-npm-package/index.md).
...
However, we recommend that [activity tracking](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/activity-page-pings/index.md) (page pings) is enabled immediately following initialization.
...
Adding this code to your site will cause [page ping events](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/activity-page-pings/index.md) to be automatically tracked and sent via POST.
