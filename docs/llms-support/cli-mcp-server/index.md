...
The [Snowplow CLI](/docs/api-reference/snowplow-cli/index.md) includes a local Model Context Protocol (MCP) server that enables natural language interaction with AI assistants for creating, validating, and managing your Snowplow tracking plans. This allows you to:
...
The MCP server is included with [Snowplow CLI](/docs/api-reference/snowplow-cli/index.md). Start by installing the CLI and authenticating to your Snowplow account.
...
Use the standard [Snowplow CLI commands](/docs/api-reference/snowplow-cli/reference/index.md) to publish your changes to [Console](https://console.snowplowanalytics.com) when ready, using the standard Snowplow CLI commands such as `snowplow-cli ds publish`.
