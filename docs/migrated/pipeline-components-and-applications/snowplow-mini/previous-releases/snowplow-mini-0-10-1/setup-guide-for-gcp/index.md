...
imported-sp-mini \
--source-uri \
https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-large-1599488660.tar.gz
```
...
| --- | --- | --- |
| [large](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-large-1599488660.tar.gz) | [xlarge](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-xlarge-1599488625.tar.gz) | [xxlarge](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-xxlarge-1599489808.tar.gz) |
...
If you want, you can download [`large`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-large-1599488660.tar.gz) , [`xlarge`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-xlarge-1599488625.tar.gz) and [`xxlarge`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-10-1-xxlarge-1599489808.tar.gz) for other usages/purposes.
