...
The Snowplow CLI includes an [MCP server](/docs/llms-support/cli-mcp-server/) to help you translate your Adobe Analytics event configuration into Snowplow tracking plans.
:::
