...
Specify the optional `"userId"` var to set the uid/user_id  [Snowplow Tracker Protocol](/docs/snowplow-events/index.md#user-related-parameters) field.
...
Specify the optional "nameTracker" var to set the tna/name_tracker [Snowplow Tracker Protocol](/docs/snowplow-events/index.md#application-parameters) field.
