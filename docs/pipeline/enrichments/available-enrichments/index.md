...
| [Cross Navigation](/docs/pipeline/enrichments/available-enrichments/cross-navigation-enrichment/index.md) | Parse the extended cross navigation format in `_sp` query string parameter and attach the `cross_navigation` entity to an event. Available since Enrich version 4.1.0.                                                                                |
