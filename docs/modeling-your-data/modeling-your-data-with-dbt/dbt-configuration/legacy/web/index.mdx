...
sidebar_label: "Web"
description: "Configure the legacy Web dbt package for web event data modeling. Superseded by the Unified Digital package."
keywords: ["Web configuration", "legacy web package", "dbt web package"]
