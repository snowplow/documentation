...
We have built [snowplow-cli](/docs/data-product-studio/data-products/managing-your-data-structures/cli/) to help you bridge the gap between these repository based workflows and BDP Console.

## Prerequisites

* A deployed Snowplow BDP pipeline
* [snowplow-cli](/docs/data-product-studio/data-products/managing-your-data-structures/cli/#download) downloaded and configured
...
:::note
This directory layout and file naming scheme is also followed by the [download](/docs/data-product-studio/data-products/managing-your-data-structures/cli/#downloading-data-structures) command.
:::
...
* `meta.hidden` directly relates to showing and hiding [in BDP Console UI](/docs/data-product-studio/data-products/managing-your-data-structures/ui/#hiding-a-data-structure)
...
Apart from the missing descriptions everything looks good. We can fill them in later. Let's go ahead and publish our data structure to our [development](/docs/data-product-studio/data-quality/testing-and-qa-workflows/) environment.
...
We would like pushes to our `develop` branch to be automatically published to our [development](/docs/data-product-studio/data-quality/testing-and-qa-workflows/) environment. Github workflows can be [triggered](https://docs.github.com/en/actions/writing-workflows/choosing-when-your-workflow-runs/triggering-a-workflow) by all kinds of repository events. The one we are interested in here:
```yml
on:
  push:
    branches: [develop]
