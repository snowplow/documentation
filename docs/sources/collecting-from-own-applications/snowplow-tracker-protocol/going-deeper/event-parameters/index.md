...
To learn about self-describing events and how they are serialized in the tracker payload, [visit this page](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/custom-events/self-describing-events/index.md).
...
If enabled, the [activity tracking function](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/index.md#activity-tracking-page-pings) checks for engagement with a page after load. (E.g. mousemovement, scrolling etc...).
...
To learn about context entities and how they are serialized in the event payload, [visit this page](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/custom-events/context-entities/index.md).
...
`u` is a reserved parameter because it is used for [click tracking in the Pixel Tracker](/docs/sources/collecting-from-own-applications/pixel-tracker/index.md#click-tracking).
