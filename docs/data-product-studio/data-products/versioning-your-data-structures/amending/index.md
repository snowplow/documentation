...
* If you are using Snowplow BDP, select the “Patch” option [in the UI](/docs/data-product-studio/data-products/managing-your-data-structures/ui/index.md) when saving the schema
* If you are using Snowplow Community Edition, do not increment the schema version when [uploading it with `igluctl`](/docs/data-product-studio/data-products/managing-your-data-structures/iglu/index.md)
...
You need to be on Enrich 3.8.0+ and Iglu Server 0.11.0+ to use this feature. Additionally, if you are using [Snowplow Mini](/docs/api-reference/snowplow-mini/overview/index.md) or [Snowplow Micro](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/index.md), you will need version 0.17.0+ or 1.7.1+ respectively.
...
* [Set the version](/docs/data-product-studio/data-products/versioning-your-data-structures/index.md) of the new schema as usual, i.e. `1-0-3` if there are no breaking changes or `2-0-0` if there are.
* [Add](/docs/data-product-studio/data-products/managing-your-data-structures/index.md) the new schema to your production environment.
...
Finally, if we [browse](/docs/data-product-studio/data-products/managing-your-data-structures/index.md) schema version `1-0-2`, we will see that Iglu Server automatically keeps track of which schema supersedes which. Specifically, it will now contain a `$supersededBy` definition:
