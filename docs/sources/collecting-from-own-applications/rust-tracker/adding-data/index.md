...
Please refer to the section on subject configuration on the [Configuration page](/docs/sources/collecting-from-own-applications/rust-tracker/initialization-and-configuration/index.md) to learn more.
