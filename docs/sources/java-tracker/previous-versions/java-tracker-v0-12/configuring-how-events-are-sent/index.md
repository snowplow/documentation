...
Note for Gradle users: [different dependencies](/docs/sources/java-tracker/previous-versions/java-tracker-v0-12/installation-and-set-up/index.md) are required if you are using OkHttp or Apache HTTP.
