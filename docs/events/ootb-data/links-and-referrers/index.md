...
| [Flutter](/docs/sources/flutter-tracker/tracking-events/index.md#track-deep-link-received-events-with-deeplinkreceived) | ✅         | 0.8.0                                              | ❌             | Based on Deep Link events          |
| Roku                                                                                                           | ❌         |                                                    |               |                                    |
...
We recommend using the [Base web tracking plan template](/docs/event-studio/tracking-plans/templates/index.md#base-web) for web tracking. It includes link clicks.
