...
This type is recommended for use with Snowplow BDP via the [Data Structures API](/docs/data-product-studio/data-products/managing-your-data-structures/api/index.md).

In order to function, the extension requires:

- Organization ID: This is usually found in the URL when logged into the Snowplow BDP console. See more at [Managing Console API authentication](/docs/account-management/api-credentials/index.md#credentials-ui-v2).
- API Key: When logged into the Snowplow BDP console, should be available in [API keys for managing Snowplow](https://console.snowplowanalytics.com/credentials) (within "Manage organization"). See more at [Managing Console API authentication](/docs/account-management/api-credentials/index.md#credentials-ui-v2).
