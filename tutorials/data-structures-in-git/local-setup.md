...
:::note
This directory layout and file naming scheme is also followed by the [download](/docs/api-reference/snowplow-cli/data-structures/#downloading-data-structures) command.
:::
...
* `data` is the actual [snowplow self describing schema](/docs/fundamentals/schemas/#self-describing-json-schema-anatomy) that this data structure describes
