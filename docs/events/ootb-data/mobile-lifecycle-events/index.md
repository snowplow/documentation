...
We recommend using the [Base mobile tracking plan template](/docs/event-studio/tracking-plans/templates/index.md#base-mobile) for mobile tracking. It includes install and lifecycle events.
