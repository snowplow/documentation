export const Schema = {
  ...
  properties: {
    ...
    snowplow__backfill_limit_days: {
      ...
      group: 'Operation and Logic',
      longDescription: 'The maximum numbers of days of new data to be processed since the latest event processed. Please refer to the [incremental logic]([Utilizing custom contexts or SDEs](/docs/modeling-your-data/modeling-your-data-with-dbt/package-mechanics/incremental-processing#package-state)) section for more details.',
      packageDefault: '30',
      description:
