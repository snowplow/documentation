...
This page refers to version 0.5.0 of Snowplow Mini for AWS. It also assumes an already running Snowplow Mini instance.
...
![kibana-discover-ui](images/quickstart-view-data-in-kibana-1.png)
...
![kibana-discover-ui-zoom-in-on-bar](images/quickstart-view-data-in-kibana-2.png)

You can then inspect the individual event data in the UI below:

![kibana-discover-ui-zoom-in-on-bar](images/quickstart-view-data-in-kibana-3.png)
...
`0.5.0` is the first Snowplow Mini version compatible with the [PII Enrichment](/docs/migrated/enriching-your-data/available-enrichments/pii-pseudonymization-enrichment/).
