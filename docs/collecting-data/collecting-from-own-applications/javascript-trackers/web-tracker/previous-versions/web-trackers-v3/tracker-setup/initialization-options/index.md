...
| [`encodeBase64`](../configuring-how-events-sent#base64-encoding)                                          | Enable Base64 encoding for JSONs (context entities and custom self-describing events).               | true                    | `boolean`     |
