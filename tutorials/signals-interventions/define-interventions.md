...
3. Your Web application can receive intervention notifications via the [browser tracker plugin](/docs/signals/applications/subscribe/#subscribe-with-the-browser-tracker-plugin) directly on the frontend
...
These [rule-based interventions](/docs/signals/interventions/) will be triggered automatically when their criteria are met.
...
In the next section, you'll use the demo e-shop application to see these interventions in action. The app uses the [browser tracker plugin](/docs/signals/applications/subscribe/#subscribe-with-the-browser-tracker-plugin) to automatically receive and display intervention banners when they trigger.
