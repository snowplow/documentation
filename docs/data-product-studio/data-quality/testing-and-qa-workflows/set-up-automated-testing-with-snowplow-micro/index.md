...
[Snowplow Micro](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/what-is-micro/index.md) is a lightweight version of the Snowplow pipeline which is great for testing.
...
Using the [JavaScript Tracker](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/index.md):
