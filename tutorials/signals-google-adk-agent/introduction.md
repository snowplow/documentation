...
- Capture recent session activity with a Signals agentic context
- Inject both into the agent's system instruction on every turn, using a `before_model_callback`
