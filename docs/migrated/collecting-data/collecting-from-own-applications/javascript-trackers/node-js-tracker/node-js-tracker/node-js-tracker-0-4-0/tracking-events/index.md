...
Details of other tracking methods are available in the documentation for the [tracker core](/docs/migrated/collecting-data/collecting-from-own-applications/node-js-tracker/javascript-tracker-core/).
