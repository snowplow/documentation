...
The process involves the following high level steps:
  ...
  - If manually inserting the tag into your website or tag management solution: Snowplow customers can generate a tag snippet by creating a [source application](/docs/event-studio/source-applications/index.md) and using the **Set up tracking** tab. Other users can use and edit the standard tag [here](../tracker-setup/index.md).
