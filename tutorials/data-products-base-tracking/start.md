...
description: "Learn how to implement web tracking using Event Studio, source applications, and Snowtype code generation for a React TodoMVC application."
keywords: ["event studio tutorial", "snowtype code generation"]
---
...
- A [Console API key](/docs/event-studio/implement-tracking/#authenticating-with-the-console) for generating code using Snowtype.
