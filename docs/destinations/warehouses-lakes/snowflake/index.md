...
* Create a role with the following permissions:
  * `USAGE`, `OPERATE` on warehouse (for testing the connection and monitoring, e.g. as part of the [Data Quality Dashboard](/docs/monitoring/monitoring-failed-events/index.md#data-quality-dashboard))
  * `USAGE` on database
