    ...
    <Layout title="Tailwind Test Page">
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="space-y-4 mb-8">
          ...
          <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded ml-4 flex items-center gap-2">
            <CheckCircle className="w-4 h-4" />
            Success Button
          </button>
          <button className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded ml-4 flex items-center gap-2">
