 ...
 * **Tracking plans** are containers for related event specifications. They were previously called "data products"; that name is still used within some Snowplow components.
