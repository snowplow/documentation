...
description: "Configure the Media Player dbt package for tracking video and audio playback metrics with customizable variables."
keywords: ["Media Player configuration", "dbt media player package", "video analytics", "configure media player model", "configure dbt"]
sidebar_position: 20
---
...
<DbtConfigurationPage schemaName="dbtMediaPlayer" versions={getSchemaVersions('dbtMediaPlayer')} label="dbt media player version">
