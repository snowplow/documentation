...
| [React Native](/docs/sources/react-native-tracker/index.md)                          | ❌         |               |               | Earlier versions of the React Native tracker supported error tracking for mobile platforms. This feature was removed in version 4.0.0 as it didn't work with JavaScript. Track errors manually using the `application_error` schema. |
| [Flutter](/docs/sources/flutter-tracker/index.md)                                    | ❌         |               |               | Use the `application_error` schema for your own custom event.                                                                                                                                                                        |
| [Roku](/docs/sources/roku-tracker/index.md)                                          | ❌         |               |               | Use the `application_error` schema for your own custom event.                                                                                                                                                                        |
