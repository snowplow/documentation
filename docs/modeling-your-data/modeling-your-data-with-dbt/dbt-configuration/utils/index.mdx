---
title: "Configure the Utils data model"
sidebar_label: "Utils"
description: "Configure the Utils dbt package with core macros and helper functions for Snowplow data modeling."
keywords: ["Utils configuration", "dbt utils package", "dbt macros", "configure utils", "configure dbt"]
sidebar_position: 60
---
...
export const printYamlVariables = (data) => {
  return(
    <>
      ...
      <CodeBlock language="yaml">{dump({vars: {"snowplow_utils": data}}, { flowLevel: 3 })}</CodeBlock>
    </>
  )
}
...
<DbtConfigurationPage schemaName="dbtUtils" versions={getSchemaVersions('dbtUtils')} label="dbt utils version">
