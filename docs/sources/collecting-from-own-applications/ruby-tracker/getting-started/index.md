...
This Tracker will send events via GET to `http://collector.example.com/i`. To use other settings, such as POST or HTTPS, see "[Configuring how events are sent](/docs/sources/collecting-from-own-applications/ruby-tracker/configuring-how-events-are-sent/index.md)".
