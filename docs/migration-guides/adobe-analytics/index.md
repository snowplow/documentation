...
The Snowplow CLI includes an [MCP server](/docs/ai/cli-mcp-server/) to help you translate your Adobe Analytics event configuration into Snowplow tracking plans.
:::
