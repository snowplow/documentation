...
As well as managing [data products](/docs/data-product-studio/data-products/data-products/index.md) through the Snowplow BDP Console, Snowplow BDP customers can also manage them programmatically through an API.
