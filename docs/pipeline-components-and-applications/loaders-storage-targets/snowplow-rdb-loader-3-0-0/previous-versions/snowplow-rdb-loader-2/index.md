...
Before setting up RDB Loader its recommended to [setup and launch Redshift cluster](/docs/setup-snowplow-on-aws/setup-destinations/setup-redshift/) first.
