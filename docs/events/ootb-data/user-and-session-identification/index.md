...
Snowplow tracks several identifiers to help you understand user behavior across sessions and devices. Read more about these in the [User and session identifiers](/docs/events/identifiers/index.md) page.
