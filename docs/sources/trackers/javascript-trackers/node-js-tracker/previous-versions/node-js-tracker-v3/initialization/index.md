...
interface Emitter {
  ...
  /** Set if the requests from the emitter should be anonymized. Read more about anonymization used at https://docs.snowplow.io/docs/snowplow-events/going-deeper/http-headers/. Available from 3.21.0 onwards */
