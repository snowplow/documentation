...
You can use the full config generator on the [configuration page](/docs/data-models/modeling-your-data-with-dbt/dbt-configuration/legacy/web/index.mdx) to help you generate your conversion event definitions.
