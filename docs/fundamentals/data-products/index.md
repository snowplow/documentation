...
To understand how to get started with data products, see [Defining the Data to collect with Data Products](/docs/data-product-studio/data-products/defining-the-data-to-collect-with-data-poducts/) for further details.