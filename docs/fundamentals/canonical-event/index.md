...
| Payload property | Field name         | Type | Description                                                            | Reqd? | Example                     | Source                                                                                                             | Web | Mobile |
| ---------------- | ------------------ | ---- | ---------------------------------------------------------------------- | ----- | --------------------------- | ------------------------------------------------------------------------------------------------------------------ | --- | ------ |
| `url`            | `page_url`         | text | The page URL                                                           | No    | `https://www.snowplow.io`   | Tracking                                                                                                           | ✅   | ❌      |
|                  | `page_urlscheme`   | text | Scheme, also known as protocol                                         | No    | `https`                     | Default enrichment                                                                                                 | ✅   | ❌      |
|                  | `page_urlhost`     | text | Host, also known as domain                                             | No    | `www.snowplowanalytics.com` | Default enrichment                                                                                                 | ✅   | ❌      |
|                  | `page_urlport`     | int  | Port if specified, scheme dependent if not; 443 for HTTPS, 80 for HTTP | No    | `80`                        | Default enrichment                                                                                                 | ✅   | ❌      |
...
|                  | `refr_urlpath`     | text | Referrer page path                                                     | No    | `/images/search`            | Default enrichment                                                                                                 | ✅   | ❌      |
