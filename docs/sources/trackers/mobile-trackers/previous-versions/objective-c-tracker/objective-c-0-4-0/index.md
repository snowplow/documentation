...
schema: "TechArticle"
keywords: ["Objective-C V0.4.0", "iOS Legacy", "Legacy iOS", "Previous Version", "Deprecated iOS", "Old iOS"]
date: "2020-03-02"
...
Assuming you have completed the [iOS Tracker Setup](/docs/sources/trackers/mobile-trackers/installation-and-set-up/index.md?platform=ios#installing) for your project, you are now ready to initialize the Snowplow Tracker.
