---
title: "Snowplow dbt Media Player v1.0.0 released"
...
components:
  - "Data models"
---
We're happy to announce a new [release](https://github.com/snowplow/dbt-snowplow-media-player/releases/tag/1.0.0) for Media Player
