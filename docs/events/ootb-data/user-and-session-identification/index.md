...
| [Roku](/docs/sources/roku-tracker/adding-data/index.md)                              | ✅         | 0.2.0         | Set `user_id` and `network_userid` only. Automatically populate `domain_userid`, `domain_sessionid`, and `domain_sessionidx` by configuring `sessionAsCookies`.                                                  |
