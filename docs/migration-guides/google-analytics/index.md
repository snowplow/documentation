...
The Snowplow CLI includes an [MCP server](/docs/api-reference/snowplow-cli/index.md#mcp-server) to help you translate your GA4 event configuration into Snowplow tracking plans.
:::
