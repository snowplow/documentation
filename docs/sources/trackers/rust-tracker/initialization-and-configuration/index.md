...
The configured attributes are mapped to Snowplow event properties described in the [Snowplow Tracker Protocol](/docs/snowplow-events/index.md). They are mapped as follows:
