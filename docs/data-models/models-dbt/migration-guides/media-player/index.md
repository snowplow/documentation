...
### Upgrading to 0.7.0
**This version requires a [full refresh run](/docs/data-models/models-dbt/dbt-operation/full-or-partial-refreshes/#complete-refresh-of-snowplow-package) if you have been using any previous versions.** You will not be able to upgrade and have the package work without doing a full refresh.
...
- You must add the following to the top level of your project yaml
    ...
    ```
- Other changes required by [snowplow-utils version 0.14.0](/docs/data-models/models-dbt/migration-guides/utils/index.md#upgrading-to-0140)
- Other changes required by [snowplow-web version 0.14.0](/docs/data-models/models-dbt/migration-guides/web/index.md#upgrading-to-0140), in particular the deduplication logic for Redshift and Postgres users
