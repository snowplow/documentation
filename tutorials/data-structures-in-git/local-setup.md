...
* `meta.hidden` directly relates to showing and hiding [in Snowplow Console UI](https://docs.snowplow.io/docs/data-product-studio/data-structures/manage/#hiding-a-data-structure)
