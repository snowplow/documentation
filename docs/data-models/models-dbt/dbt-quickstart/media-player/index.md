...
For other variables you can configure please see the [model configuration](/docs/data-models/models-dbt/dbt-configuration/index.md#model-configuration) section.
