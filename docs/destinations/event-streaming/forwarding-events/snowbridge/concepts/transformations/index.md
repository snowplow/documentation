...
You can find more detail on setting up custom scripts [in the configuration section](/docs/destinations/event-streaming/forwarding-events/snowbridge/configuration/transformations/index.md).
