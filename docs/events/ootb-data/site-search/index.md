...
This table shows the support for site search tracking across the main [Snowplow tracker SDKs](/docs/sources/index.md).

| Tracker                                                                   | Supported | Since version | Auto-tracking |
| ------------------------------------------------------------------------- | --------- | ------------- | ------------- |
| [Web](/docs/sources/web-trackers/tracking-events/site-search/index.md)    | ✅         | 2.0.0         | ❌             |
| iOS                                                                       | ❌         |               |               |
| Android                                                                   | ❌         |               |               |
| React Native                                                              | ❌         |               |               |
| Flutter                                                                   | ❌         |               |               |
...
Site search events require manual tracking. You need to call the tracking method when a user performs a search on your site.
