...
- The `track_xxx()` functions have been deprecated in favor of the `Event` class, further information on tracking events using the new API can be found on the [Event Tracking](/docs/sources/collecting-from-own-applications/python-tracker/tracking-specific-events/index.md) page.
