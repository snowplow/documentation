...
The Snowplow CLI includes an [MCP server](/docs/llms-support/cli-mcp-server/) to help you translate your Mixpanel Tracking Plans into Snowplow tracking plans.
:::
