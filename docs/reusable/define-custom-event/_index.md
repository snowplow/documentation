...
To define your own custom event, you will need to [create a corresponding schema](/docs/event-studio/data-structures/index.md). Snowplow uses the schema to validate that the JSON containing the event properties is well-formed.
