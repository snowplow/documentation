...
### Overview
[Standard data models](/docs/data-models/modeling-your-data-with-dbt/dbt-models/) are authored and maintained by Snowplow. Follow the steps below to create and run one.
