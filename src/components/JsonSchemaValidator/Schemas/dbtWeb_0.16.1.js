export const Schema = {
  ...
  properties: {
    ...
    snowplow__cwv_context: {
      ...
      packageDefault: 'unstruct_event_com_snowplowanalytics_snowplow_web_vitals_1',
      group: 'Warehouse Specific',
    },
    ...
    snowplow__entities_or_sdes: {
      ...
      longDescription: 'A list of dictionaries defining the `context` or `self-describing` event tables to join onto your base events table. Please use the tool below or see the section on [Utilizing custom contexts or SDEs](/docs/modeling-your-data/modeling-your-data-with-dbt/dbt-models/dbt-utils-data-model/dbt-utils-advanced-operation/index.md?warehouse=redshift%2Bpostgres#utilizing-custom-contexts-or-sdes) for details of the structure.',
      packageDefault: '[]',
      warehouse: 'Redshift',
        group: 'Warehouse Specific',
        type: 'array',
