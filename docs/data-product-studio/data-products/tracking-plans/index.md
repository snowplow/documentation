...
As explained in [Introduction to tracking design](/docs/data-product-studio/data-products/tracking-design/index.md), to use Snowplow successfully, you need to have a good idea of:
