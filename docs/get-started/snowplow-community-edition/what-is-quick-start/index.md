...
- Collect granular, well-structured data with our suite of web, mobile and server side [SDKs](/docs/sources/collecting-from-own-applications/index.md)
...
- Easily enable and disable our suite of [out-of-the-box enrichments](/docs/pipeline/enriching-your-data/available-enrichments/index.md)
