...
<tr>
    ...
    <td>Required. Type of transformation, either `shred` or `widerow`. See <a href="/docs/pipeline-components-and-applications/loaders-storage-targets/snowplow-rdb-loader/transforming-enriched-data/#shredded-data">Shredded data</a> and <a href="/docs/pipeline-components-and-applications/loaders-storage-targets/snowplow-rdb-loader/transforming-enriched-data/#wide-row-format">Wide row format</a>.</td>
</tr>
<tr>
