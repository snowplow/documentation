...
For general testing, [Snowplow Mini](/docs/migrated/understanding-your-pipeline/what-is-snowplow-mini/) can be used as an easily deployable collector with a live web interface for viewing received events.
...
[Here](/docs/migrated/collecting-data/collecting-from-own-applications/snowplow-tracker-protocol/) a full list of the supported platform values.
