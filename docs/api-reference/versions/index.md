...
[Snowbridge](/docs/destinations/event-streaming/forwarding-events/snowbridge/index.md) | ${versions.snowbridge}
...
If you are using Snowplow BDP, you don’t need to install Iglu Server yourself. It’s also unlikely that you need to use any of the other components in this section. You can manage your data structures [in the UI or via the API](/docs/data-product-studio/data-products/managing-your-data-structures/index.md).
...
:--|:-:
[Snowplow Micro](/docs/data-product-studio/data-quality/testing-debugging/snowplow-micro/what-is-micro/index.md) | ${versions.snowplowMicro}
...
SDK | Latest version
:--|:-:
[Scala](/docs/destinations/event-streaming/analytics-sdk/analytics-sdk-scala/index.md) | ${versions.analyticsSdkScala}
[Javascript](/docs/destinations/event-streaming/analytics-sdk/analytics-sdk-javascript/index.md) | ${versions.analyticsSdkJavascript}
[Python](/docs/destinations/event-streaming/analytics-sdk/analytics-sdk-python/index.md) | ${versions.analyticsSdkPython}
[.NET](/docs/destinations/event-streaming/analytics-sdk/analytics-sdk-net/index.md) | ${versions.analyticsSdkDotNet}
[Go](/docs/destinations/event-streaming/analytics-sdk/analytics-sdk-go/index.md) | ${versions.analyticsSdkGo}
`} remarkPlugins={[remarkGfm]} />
