...
To follow the steps below, you will need to be running [Snowbridge](/docs/destinations/event-streaming/forwarding-events/snowbridge/index.md) 2.3+. You will also need to have the [`spGtmssPreview` transformation](/docs/destinations/event-streaming/forwarding-events/snowbridge/configuration/transformations/builtin/spGtmssPreview.md) activated (this is the default for Snowplow BDP customers using Snowbridge with GTM Server Side).
...
For example, if you are using the [JavaScript tracker](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/index.md):
...
You can also add it as a [global context](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/custom-tracking-using-schemas/global-context/index.md) for all events:
