...
| React Native                                                                     |                                                                                | ❌         |                                    |               | Use the media schemas for your own custom events, or the [media web tracking plan template](/docs/event-studio/tracking-plans/templates/index.md#media-web) |
...
We recommend using the [Media base tracking plan template](/docs/event-studio/tracking-plans/templates/index.md#media-web) for media tracking on web.
