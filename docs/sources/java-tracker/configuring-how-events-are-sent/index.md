...
:::note
Gradle users: [different dependencies](/docs/sources/java-tracker/installation-and-set-up/index.md) can be configured if you are using OkHttp or Apache HTTP.
:::
