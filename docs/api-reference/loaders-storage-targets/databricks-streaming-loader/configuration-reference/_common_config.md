...
<tr>
    <td><code>decompression.maxBytesInBatch</code> (since 0.5.0)</td>
    <td>
...
<tr>
    <td><code>decompression.maxBytesSinglePayload</code> (since 0.5.0)</td>
    <td>
...
<tr>
    <td><code>monitoring.metrics.prometheus.tags.*</code> (since 0.5.0)</td>
