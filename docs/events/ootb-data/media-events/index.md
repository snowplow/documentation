...
| React Native                                                                     |                                                                                | ❌         |                                    |               | Use the media schemas for your own custom events, or the [media web tracking plan template](/docs/data-product-studio/data-products/data-product-templates/index.md#media-web) |
...
We recommend using the [Media base tracking plan template](/docs/data-product-studio/data-products/data-product-templates/index.md#media-web) for media tracking on web.
