...
See [Tracking events](/docs/sources/collecting-from-own-applications/java-tracker/previous-versions/java-tracker-v0-12/tracking-events/index.md) to learn how to track events with the Java tracker.
