---
title: "Running custom dbt models via Snowplow"
...
If you are a Snowplow customer, you can get started with configuring and deploying dbt projects as outlined in the steps below. For more information about setting up your dbt project you can look at the [Snowplow dbt docs](/docs/modeling-your-data/modeling-your-data-with-dbt/index.md).
...
The warehouse password should be sent by [secure form from the Snowplow Console](https://console.snowplowanalytics.com/secure-messaging/freeform) in order to set the environment variables.
...
Once everything is set up, Snowplow Console will run the following commands in this order:
