...
* [Screen view](/docs/snowplow-events/ootb-data/page-and-screen-view-events/index.md#screen-view-events)
* [Screen end](/docs/snowplow-events/ootb-data/page-activity-tracking/index.md#screen-end-event)
* [Application install](/docs/snowplow-events/ootb-data/mobile-lifecycle-events/index.md#install-event)
* [Application background](/docs/snowplow-events/ootb-data/mobile-lifecycle-events/index.md#background-event)
* [Application foreground](/docs/snowplow-events/ootb-data/mobile-lifecycle-events/index.md#foreground-event)
...
Tracked using the [out-of-the-box e-commerce events](/docs/snowplow-events/ootb-data/ecommerce-events/index.md) for web, Android, and iOS. On web, this requires the [Snowplow Ecommerce plugin](/docs/sources/trackers/javascript-trackers/web-tracker/tracking-events/ecommerce/index.md).
