...
Repeater has several important behavioraspects:
...
- Forwarder keeps retrying all inserts (default behaviorfor streaming Dataflow jobs), while Repeater has a dead-end GCS bucket.
