...
description: "How to install the Snowplow CLI and configure MCP clients such as Claude Desktop, VS Code, and Cursor."
keywords: ["Snowplow CLI", "MCP", "installation", "Claude Desktop", "VS Code", "Cursor"]
---
...
The Snowplow CLI MCP server can be used with any MCP-compatible client. Below are configuration examples for popular clients. For a complete list of supported clients and their configurations, see the [MCP reference](/docs/api-reference/snowplow-cli/reference/#mcp).
