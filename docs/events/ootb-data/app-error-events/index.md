...
| [React Native](/docs/sources/react-native-tracker/index.md)                          | ❌         |               |               | Earlier versions of the React Native tracker supported error tracking for mobile platforms. This feature was removed in version 4.0.0 as it didn't work with JavaScript. Track errors manually using schemas. |
