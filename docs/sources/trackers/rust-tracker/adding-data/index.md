...
Please refer to the section on subject configuration on the [Configuration page](/docs/sources/trackers/rust-tracker/initialization-and-configuration/index.md) to learn more.
