...
Read more about tracking client-side/server-side [here](docs/sources/collecting-from-own-applications/java-tracker/tracking-specific-client-side-properties/index.md).
