...
`0.5.0` is the first Snowplow Mini version compatible with the [PII Enrichment](/docs/enriching-your-data/available-enrichments/pii-pseudonymization-enrichment.md).
