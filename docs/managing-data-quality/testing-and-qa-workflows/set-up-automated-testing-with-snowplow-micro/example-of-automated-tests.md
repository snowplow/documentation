...
With this command you can look specifically for [unstructured events](/docs/understanding-tracking-design/understanding-schemas-and-validation.md), which include both custom unstructured events and all other default Snowplow events that are of "unstruct" eventType (link-click, submit-form, ad-impression etc.)
