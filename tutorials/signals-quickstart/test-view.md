...
The test method returns the most recent 10 rows. The first column shows the attribute key values, in this case for the session attribute key `domain_sessionid`.
