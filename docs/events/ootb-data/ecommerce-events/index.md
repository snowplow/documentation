...
We recommend using the [Ecommerce base tracking plan template](/docs/data-product-studio/data-products/data-product-templates/index.md#ecommerce-web-and-mobile) for ecommerce tracking.
