...
`0.6.0` is the first Snowplow Mini version offered on GCP!
...
To use them within GCP console, you need to import into your GCP project. You can use `gcloud` CLI utility to do that.
...
imported-sp-mini \
--source-uri \
https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-large-1533642312.tar.gz
```
...
| --- | --- | --- |
| [https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-large-1533642312.tar.gz](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-large-1533642312.tar.gz) | [https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-xlarge-1533643449.tar.gz](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-xlarge-1533643449.tar.gz) | [https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-xxlarge-1533644125.tar.gz](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-xxlarge-1533644125.tar.gz) |
...
### [](https://github.com/snowplow/snowplow-mini/wiki/Setup-guide-GCP---0.6.0#large--xlarge--xxlarge)large & xlarge & xxlarge
...
If you want, you can download [`large`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-large-1533642312.tar.gz) , [`xlarge`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-xlarge-1533643449.tar.gz) and [`xxlarge`](https://storage.googleapis.com/snowplow-mini/snowplow-mini-0-6-0-xxlarge-1533644125.tar.gz) for other usages/purposes.
