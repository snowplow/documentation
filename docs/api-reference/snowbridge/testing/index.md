...
You can get started working with Snowplow data by [downloading this file](pathname://./assets/input.txt) which contains a sample of web and mobile Snowplow events in TSV format. However, if you need events that match your actual events, generate your own events sample.
