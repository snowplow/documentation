...
This package has been superseded by the [Unified Digital](/docs/data-models/models-dbt/dbt-models/dbt-unified-data-model/index.md) that combines data from both web and mobile sources. For more information, see the Unified Digital page.
