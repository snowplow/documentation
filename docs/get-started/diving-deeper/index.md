...
* Browse the [recipes](/docs/recipes-tutorials/index.md) — short guides for common use cases
...
* Learn more about [defining the shape of your data](/docs/data-product-studio/data-products/index.md): tracking design, managing and versioning your schemas
* Take a look at the [enrichment process](/docs/pipeline/enriching-your-data/index.md) and the available enrichments, which can add extra information to your data
