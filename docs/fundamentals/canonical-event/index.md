...
For more information on this topic please check out the relevant [Tracking Documentation](/docs/snowplow-events/ootb-data/device-and-browser/index.md).
#### Location fields
...
For more information on this topic please check out the relevant [Tracking Documentation](/docs/snowplow-events/ootb-data/geolocation/index.md).
...
For more information on this topic please check out the relevant [Tracking Documentation](/docs/snowplow-events/ootb-data/ecommerce-events/index.md).
...
For more information on this topic please check out the relevant [Tracking Documentation](/docs/snowplow-events/custom-events/structured-events/index.md).
...
For more information on this topic please check out the relevant [Tracking Documentation](/docs/snowplow-events/custom-events/self-describing-events/index.md).
...
For more information on this topic please check out the relevant [Tracking Documentation](/docs/snowplow-events/custom-events/context-entities/index.md).
