...
| [Browser](/docs/events/ootb-data/device-and-browser/index.md#browser-context)                                   | web    | `snowplow__enable_browser_context`, `snowplow__enable_browser_context_2` (depending on schema versions tracked, when both are enabled the values are coalesced) |
