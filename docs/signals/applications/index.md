...
* [Signals MCP server](/docs/signals/applications/mcp-server/index.md): let your agent discover the agentic contexts your deployment publishes and pick the ones that fit the task
