...
For more details on how all these variables combine, please see the docs on the [incremental logic](https://docs.snowplow.io/docs/data-models/models-dbt/package-mechanics/incremental-processing/index.md) of our packages.
