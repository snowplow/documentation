...
* **NOTE:** In Redshift, changing _size_ may also mean _type_ change; e.g. changing the `maximum` integer from say `30000` to `100000` (see [Numeric types - Amazon Redshift](https://docs.aws.amazon.com/redshift/latest/dg/r_Numeric_types201.html))
