...
description: "Build an abandoned browse tracking and re-engagement system using Snowplow, Snowflake, Census, and Braze. Learn how a composable CDP approach helps recover lost ecommerce conversions through personalized campaigns."
keywords: ["composable cdp abandoned browse", "ecommerce cart abandonment", "snowplow snowflake census", "behavioral tracking tutorial"]
---
...
---
![Re-engagement email in Gmail from Snowplow Store with subject "Did you forget something??" and a personalized message reminding the recipient they viewed the Air Force 1 Shadow product](images/retl-email.png)
...
---
![Architecture diagram showing a composable CDP: Snowplow collects events from marketing websites, web apps, and mobile apps into a data warehouse (Snowflake, Databricks, BigQuery, Redshift), with Census Reverse ETL syncing the data to CRM, marketing activation, ad platforms, and product analytics](images/retl-snowplow-composable-cdp.png)
