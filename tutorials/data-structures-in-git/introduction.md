...
We have built [Snowplow CLI](/docs/data-product-studio/snowplow-cli) to help you bridge the gap between these repository-based workflows and Snowplow Console.

## Prerequisites

* A deployed Snowplow pipeline
* [Snowplow CLI](/docs/data-product-studio/snowplow-cli) installed and configured
