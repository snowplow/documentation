...
To process raw web vitals event data, we have included an optional module to model in the [snowplow-web dbt package](/docs/data-models/models-dbt/dbt-models/legacy/dbt-web-data-model/core-web-vitals-module/index.md).
