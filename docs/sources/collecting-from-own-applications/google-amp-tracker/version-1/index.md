...
Specify the optional `"userId"` var to set the uid/user_id  [Snowplow Tracker Protocol](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/index.md#user-related-parameters) field.
...
Specify the optional "nameTracker" var to set the tna/name_tracker [Snowplow Tracker Protocol](/docs/sources/collecting-from-own-applications/snowplow-tracker-protocol/index.md#application-parameters) field.
