...
You can provide a `Custom Page Title` if you wish, and you can add a [custom context](/docs/events/custom-events/index.md#custom-entities) to the request, as also described [here](/docs/sources/trackers/web-trackers/tracking-events/page-views/index.md#tracking-a-page-view).
