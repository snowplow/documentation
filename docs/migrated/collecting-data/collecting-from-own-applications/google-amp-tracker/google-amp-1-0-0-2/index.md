...
Specify the optional "nameTracker" var to set the tna/name\_tracker [Snowplow tracker protocol](/docs/migrated/collecting-data/collecting-from-own-applications/snowplow-tracker-protocol/) field.
