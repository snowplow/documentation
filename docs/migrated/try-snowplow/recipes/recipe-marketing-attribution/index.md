...
We have already created a custom `conversion` event for you, and uploaded its data structure to [your Iglu server](/docs/migrated/pipeline-components-and-applications/iglu/iglu-resolver/).
