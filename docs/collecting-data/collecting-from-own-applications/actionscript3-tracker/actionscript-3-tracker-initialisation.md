...
Assuming you have completed the [Actionscript 3 Tracker Setup](/docs/collecting-data/collecting-from-own-applications/actionscript3-tracker/setup.md) for your project, you are now ready to initialize the AS3 Tracker.
