export const Schema = {
  ...
  properties: {
    ...
    snowplow__media_player_event_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player Event Table',
      longDescription: 'The table name for your media player events.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_player_event_1',
      group: 'Warehouse Specific',
    },
    snowplow__media_player_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player Context Table',
      longDescription: 'The table name for your media player entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_player_1',
      group: 'Warehouse Specific',
    },
    snowplow__media_player_v2_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player v2 Context Table',
      longDescription: 'The table name for your media player v2 entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_player_2',
      group: 'Warehouse Specific',
    },
    snowplow__media_session_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player Session Context Table',
      longDescription: 'The table name for your media player session entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_session_1',
      group: 'Warehouse Specific',
    },
    snowplow__media_ad_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player Ad Context Table',
      longDescription: 'The table name for your media player ad entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_ad_1',
      group: 'Warehouse Specific',
    },
    snowplow__media_ad_break_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player Ad Break Context Table',
      longDescription: 'The table name for your media player ad break entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_ad_break_1',
      group: 'Warehouse Specific',
    },
    snowplow__media_ad_quartile_event: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player Ad Quartile Context Table',
      longDescription: 'The table name for your media player ad quartile entity.',
      packageDefault: 'com_snowplowanalytics_snowplow_media_ad_quartile_event_1',
      group: 'Warehouse Specific',
    },
    snowplow__youtube_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player YouTube Context Table',
      longDescription: 'The table name for your media player YouTube entity.',
      packageDefault: 'com_youtube_youtube_1',
      group: 'Warehouse Specific',
    },
    snowplow__html5_media_element_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player HTML5 Media Element Context Table',
      longDescription: 'The table name for your media player HTML5 media element entity.',
      packageDefault: 'org_whatwg_media_element_1',
      group: 'Warehouse Specific',
    },
    snowplow__html5_video_element_context: {
      type: 'string',
      warehouse: 'Redshift',
      title: '(Redshift) Media Player HTML5 Video Element Context Table',
      longDescription: 'The table name for your media player HTML5 video element entity.',
      packageDefault: 'org_whatwg_video_element_1',
      group: 'Warehouse Specific',
    },
