...
This section allows you to define [Snowplow self-describing events](/docs/sources/collecting-from-own-applications/javascript-trackers/web-tracker/tracking-events/index.md#tracking-custom-self-describing-events).
