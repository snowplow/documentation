...
For Snowplow customers that would like to benefit from seeing aggregates of failed events by type, there are relevant optional features in the Snowplow Console. Snowplow offers two different ways to monitor failed events:
...
Below is an example view of the failed events screen in the Snowplow Console:
