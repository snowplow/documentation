...
It is also possible to add contexts in a declarative way (see GlobalContextsConfiguration [here](introduction.md)), so that they are applied to all (or a subset of) events within an application.
