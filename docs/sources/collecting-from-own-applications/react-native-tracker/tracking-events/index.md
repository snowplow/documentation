...
All tracker's `track` methods take two arguments: An object of key-value pairs for the event’s properties, and an optional array of [custom event contexts](/docs/sources/collecting-from-own-applications/react-native-tracker/custom-tracking-using-schemas/index.md).
