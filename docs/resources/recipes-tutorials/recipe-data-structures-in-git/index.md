...
We have built [Snowplow CLI](/docs/data-product-studio/cli/index.md) to help you bridge the gap between these repository-based workflows and BDP Console.

## Prerequisites

* A deployed Snowplow BDP pipeline
* [Snowplow CLI](/docs/data-product-studio/cli/index.md) installed and configured
